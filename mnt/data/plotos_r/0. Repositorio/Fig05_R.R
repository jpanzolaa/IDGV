...
# Load ggplot2 and fmsb libraries
library(ggplot2)
library(fmsb)
...
png(filename = "0. Repositorio/img/Fig05.png",
    width = 900,
    height = 400,
    res = 100)

# El código completo de los gráficos va aquí
...
# Cierra el dispositivo gráfico y guarda el archivo
dev.off()

# --- Guarda la figura en formato PDF ---
pdf(file = "0. Repositorio/img/Fig05.pdf",
    width = 9,
    height = 4)

# El mismo código de los gráficos va aquí
par(mfrow = c(1, 3), oma = c(4, 0, 2, 0), mar = c(2, 2, 2, 1), xpd = TRUE)
